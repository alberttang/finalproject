    ...
    render() {
        return (
            ...
            <div className="jumbotron jumbotron-fluid">
                    <h1 className="display-4" style={{ textAlign: "center" }}>These Martial Arts are great for Stress Relief:</h1>
                    <div className="container-fluid">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3 col-xs-3">
                                <button type="button" className="btn btn-lg btn-info"><Link to={`/users/Boxing`}>Kung Fu</Link></button>
                            </div>
